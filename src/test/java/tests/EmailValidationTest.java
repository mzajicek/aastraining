...
public class EmailValidationTest extends TestBase {
    ...
    public void itShouldDisplayErrorWhenEmailIsInvalid() throws FileNotFoundException {
        ...
        //calculatorPage.selectEmail("skdffdjs");
        for (String readInvalidEmail : readInvalidEmails()){
        calculatorPage.selectEmail(readInvalidEmail);
            Assert.assertTrue(driver.findElement(By.xpath("//div[input[@id='emailInput']]")).getAttribute("class").contains("error"));
        }
    ...
    private List<String> readInvalidEmails() throws FileNotFoundException {
        ...
        //do vytvoreneho listu priradim vsetky riadky ktore som pridal
